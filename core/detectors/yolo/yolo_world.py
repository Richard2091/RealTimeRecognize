...
class YOWorldDetector(BaseDetector):
    """YOLO-World检测器"""
    ...
    def __init__(self, model_path="model/yoloworld/yolov8s-worldv2.pt", custom_classes=None):
        """
        初始化YOLO-World检测器
    ...
    def load_model(self):
        ...
        try:
            ...
            print(f"✓ 加载YOLO-World模型: {self.model_path}")
